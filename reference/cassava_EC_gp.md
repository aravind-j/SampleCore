...
accessions. The data has been partitioned into 6 clusters by hierarchial
clustering. It is used to demonstrate the various functions of
`SampleCore` package.
...
- Cluster:
  ...
  The cluster to which the accessions belong identified by hierarchial
  clustering
...
[`cassava_EC`](https://aravind-j.github.io/EvaluateCore/reference/cassava_EC.html)
...
#>       ARSR             SRDM       Cluster  
#>  Min.   : 0.000   Min.   : 0.50   I  :303  
#>  1st Qu.: 0.000   1st Qu.:35.20   II :207  
#>  Median : 1.000   Median :38.50   III:185  
#>  Mean   : 1.858   Mean   :37.77   IV :407  
#>  3rd Qu.: 3.000   3rd Qu.:41.20   V  :399  
#>  Max.   :18.000   Max.   :48.90   VI :183  
